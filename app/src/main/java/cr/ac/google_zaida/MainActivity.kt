...
class MainActivity : AppCompatActivity(), CoroutineScope by MainScope(){
    ...
    var listaDrive: MutableList<String>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        requestSigIn()
        listaDrive = mutableListOf()
        val lvDatos = findViewById<ListView>(R.id.drive_lista)
        arrayAdapter = ArrayAdapter(this, android.R.layout.simple_list_item_1, listaDrive!!)
